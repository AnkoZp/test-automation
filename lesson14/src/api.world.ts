...
import { TheCatImageApi } from './apis/the-cat-api/images.api';
...
export class ApiWorld {
    ...
    public get theCatsImagesApiService(): TheCatImageApi {
        if (!this._imagesApi) {
            this._imagesApi = new TheCatImageApi(this._theCatsFetchApiService);
        }
    ...
    public dogsImageApi: TheCatImageApi;
    ...
    public constructor() {
        ...
        this._theCatsFetchApiService = new FetchApiService(config.api.theCatsApi.baseUrl, { apiKey: config.auth?.theCatsApi?.apiKey });
        ...
        this.dogsImageApi = new TheCatImageApi(this._theCatsFetchApiService);
