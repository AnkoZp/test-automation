...
export function isFullyCharged(car: ElectricCar): boolean {
    return car.batteryLevel === 100;
}

export function simulateTrip(car: ElectricCar, consumption: number): ElectricCar {
    car.discharge(consumption);
    return car;
}
